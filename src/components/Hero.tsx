...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-20 left-20 w-24 h-24 gradient-primary rounded-full opacity-30 animate-float"
        style={{ animationDelay: "-2s" }}
      />
      <div
        className="absolute top-1/3 left-1/4 w-16 h-16 gradient-primary rounded-full opacity-25 animate-float"
        ...
        <div className="grid lg:grid-cols-2 gap-4 items-center h-full min-h-screen">
          ...
          <div className="animate-fade-in-up pt-20 lg:pt-0 px-4 lg:pl-12 flex flex-col justify-center h-full text-center lg:text-left">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-8 leading-tight overflow-visible">
              <span className="gradient-text animate-gradient block pb-2">
                Amaya
              </span>
              <span className="gradient-text animate-gradient block pb-2">
                Jayasekara
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto lg:mx-0">
              Crafting beautiful digital experiences with passion, creativity,
          ...
          {/* Right Image */}
          <div
            className="flex justify-center lg:justify-end lg:pr-12 items-center animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
            <div className="relative">
              <img
                //src="dew.jpg"
                src="images/0b268cdf-e05a-4e05-be54-2be545253639-removebg-preview.png"
